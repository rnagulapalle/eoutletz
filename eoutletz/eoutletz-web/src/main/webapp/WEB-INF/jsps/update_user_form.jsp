...
<form method="post" action="${pageContext.request.contextPath}/user/create/" id="sign-in-form">
	<input type="hidden" id="email" value="${email}" maxlength="80" size="33" name="userName" class="validate" />
	<div class="row relative">
		<label for="userName" id="activate-email-label" class="">Email address</label>
		<input type="text" id="emailLogin" maxlength="80" size="33" name="newUserName" class="validate" />
	...
	<div class="btn-wrap-no-message">
		<a class="activate-account" id="activate-account-btn">Create Account</a>
	</div>
</form>
</div>